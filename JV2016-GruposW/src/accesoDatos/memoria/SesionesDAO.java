...
public class SesionesDAO implements OperacionesDAO {
	 ...
	 * invocando al constructor interno. Utiliza inicialización diferida. Sólo
	 * se crea una vez; instancia única -patrón singleton-
	 * 
	 * @return instancia
	 */
	...
	/**
	 * Obtiene por búsqueda binaria, la posición que ocupa, o ocuparía, una
	 * sesión en la estructura.
	 * 
	 * @param idSesion
	 *            - id de Sesion a buscar.
	 * @return - la posición, en base 1, que ocupa un objeto o la que ocuparía
	 *         (negativo).
	 */
	...
	/**
	 * Búsqueda de Sesion dado un objeto, reenvía al método que utiliza
	 * idSesion.
	 * 
	 * @param obj
	 *            - la SesionUsuario a buscar.
	 ...
	 * 
	 * @param idUsr
	 *            - el identificador de usuario a buscar.
	 * @return - Sublista con las sesiones encontrada; null si no existe
	 *         ninguna.
	 */
	public List<SesionUsuario> obtenerTodasMismoUsr(String idUsr) {
		...
		// Busca posición inserción (negativa base 1) ordenada por idUsr +
		// fecha.
	...
	/**
	 * Separa en una lista independiente de todas las sesiones de un mismo
	 * usuario.
	 * 
	 * @param ultima
	 *            - el indice de una sesion almacenada.
	 * @return - Sublista con las sesiones encontrada; null si no existe
	 *         ninguna.
	 */
	...
	/**
	 * Alta de una nueva SesionUsuario en orden y sin repeticiones según IdUsr +
	 * fecha. Busca previamente la posición que le corresponde por búsqueda
	 * binaria.
	 * 
	 * @param obj
	 *            - la SesionUsuario a almacenar.
	...
	public void alta(Object obj) throws DatosException {
		...
		if (posicionInsercion < 0) {
			datosSesiones.add(-posicionInsercion - 1, sesionNueva); // Inserta
																	// la sesión
																	// en orden.
			return;
		}
	 ...
	 * 
	 * @param idSesion
	 *            - identificador de la SesionUsuario a eliminar.
	...
	/**
	 * Actualiza datos de una SesionUsuario reemplazando el almacenado por el
	 * recibido.
	 * 
	 * @param obj
	 *            - SesionUsuario con las modificaciones.
	 * @throws DatosException
	 *             - si no existe.
	 */
	@Override
	public void actualizar(Object obj) throws DatosException {
		assert obj != null;
		SesionUsuario sesionActualizada = (SesionUsuario) obj; // Para
																// conversión
																// cast
		int posicion = obtenerPosicion(sesionActualizada.getIdSesion()); // En
																			// base
																			// 1
		if (posicion > 0) {
			// Reemplaza elemento
	...
	/**
	 * Obtiene el listado de todos los identificadores de las sesiones
	 * almacenadas.
	 * 
